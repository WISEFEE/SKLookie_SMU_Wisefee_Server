...
public class CreateCafeRequestDto {
    ...
    @ApiModelProperty(value = "매장명", required = true, example = "WISEFEE Cafe")
    @NotBlank(message = "매장명은 필수 입력 값입니다.")
    private String title;

    @ApiModelProperty(value = "매장 설명", example = "상명대학교 와이즈피 카페입니다.")
    private String content;

    @ApiModelProperty(value = "매장 연락처", required = true, example = "010-0000-0000")
